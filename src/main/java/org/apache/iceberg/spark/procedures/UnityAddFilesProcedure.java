...
public class UnityAddFilesProcedure extends BaseProcedure {
    ...
    private UnityAddFilesProcedure(TableCatalog tableCatalog) {
        super(tableCatalog);
    }

    public static SparkProcedures.ProcedureBuilder builder() {
        return new BaseProcedure.Builder<UnityAddFilesProcedure>() {
            @Override
            protected UnityAddFilesProcedure doBuild() {
                return new UnityAddFilesProcedure(tableCatalog());
            }
        };
    }
