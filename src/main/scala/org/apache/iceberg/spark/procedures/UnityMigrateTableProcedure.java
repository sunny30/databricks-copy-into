...
class UnityMigrateTableProcedure extends BaseProcedure {
    ...
    private UnityMigrateTableProcedure(TableCatalog tableCatalog) {
        super(tableCatalog);
    }

    public static ProcedureBuilder builder() {
        return new BaseProcedure.Builder<UnityMigrateTableProcedure>() {
            @Override
            protected UnityMigrateTableProcedure doBuild() {
                return new UnityMigrateTableProcedure(tableCatalog());
            }
        };
    }
    ...
    public String description() {
        return "UnityMigrateTableProcedure";
    }
}
