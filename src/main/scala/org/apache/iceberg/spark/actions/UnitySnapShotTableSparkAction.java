 ...
 */
public class UnitySnapShotTableSparkAction extends UnityBaseTableCreationSparkAction<UnitySnapShotTableSparkAction>
    ...
    @Override
    public UnitySnapShotTableSparkAction as(String ident) {
    ...
    @Override
    public UnitySnapShotTableSparkAction tableProperties(Map<String, String> properties) {
        setProperties(properties);
        return this;
    }

    @Override
    public UnitySnapShotTableSparkAction tableProperty(String property, String value) {
    ...
    private SnapshotTable.Result doExecute() {
        ...
        try {
            ...
            UnitySparkTableUtil.importSparkTable(this.sourceCatalog().name(),spark(), v1TableIdent, icebergTable, stagingLocation);
...
//                catalog.name());
    ...
    @Override
    public UnitySnapShotTableSparkAction tableLocation(String location) {
        Preconditions.checkArgument(
